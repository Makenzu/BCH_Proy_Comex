...
namespace BCH.Comex.UI.Web.Areas.MT300Consulta.Controllers
{
    ...
    /// </summary>
    public class BaseControllerMT300Consulta : BaseController
    {
        ...
        protected DatosGlobales Globales
        {
            get
            {
                var dato = Session[SessionKeys.MT300Consulta.DatosGlobalesKey] as DatosGlobales;
                if (dato == null)
                {
                    Session[SessionKeys.MT300Consulta.DatosGlobalesKey] = dato = service.Iniciar(HttpContext.GetCurrentUser().GetDatosUsuario());
                }
                return dato;
            }
            set
            {
                Session[SessionKeys.MT300Consulta.DatosGlobalesKey] = value;
            }
        }
