...
namespace BCH.Comex.Core.Entities.Portal
{
    ...
    public partial class DatosUsuario
    {
        ...
        public DatosUsuario()
        {
            this.tbl_datos_usuario_codigos_sucursal = new HashSet<CodigosSucursal>();
        }
        ...
        public virtual ICollection<CodigosSucursal> tbl_datos_usuario_codigos_sucursal { get; set; }
    }
}
