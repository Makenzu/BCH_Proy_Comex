...
namespace BCH.Comex.Core.BL.XGGL.Modulos
{
    public static class MODGMEM
    {
        ...
        public static int SyPutn_Mem(DatosGlobales Globales, UnitOfWorkCext01 unit, string Tabla, int CodMem, string Memo)
        {
            ...
            try
            {
                ...
                if (CodMem == 0 && !string.IsNullOrEmpty(Memo))
                {
                    ...
                    if (_switchVar1 == "x")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.Rng_Memx));
                    }
                    else if (_switchVar1 == "m")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.Rng_Memm));
                    }
                    else if (_switchVar1 == "s")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.Rng_Mems));
                    }
                    else if (_switchVar1 == "y")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.Rng_Memy));
                    }
                    else if (_switchVar1 == "i")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.Rng_Memi));
                    }
                    else if (_switchVar1 == "p")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.Rng_Memp));
                    }
                    else if (_switchVar1 == "f")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.Rng_Memf));
                    }
                    else if (_switchVar1 == "jm")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.Rng_Memjm));
                    }
                    else if (_switchVar1 == "jd")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.Rng_Memjd));
                    }
                    else if (_switchVar1 == "e")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.Rng_Meme));
                    }
                    else if (_switchVar1 == "lm")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.Rng_Memlm));
                    }
                    else if (_switchVar1 == "ld")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.Rng_Memld));
                    }
                    else if (_switchVar1 == "c")
                    {
                        m = VB6Helpers.CInt(BCH.Comex.Core.BL.XGGL.Modulos.MODGRNG.LeeSceRng(Globales, unit, T_MODGRNG.RngMemC));
                    }
