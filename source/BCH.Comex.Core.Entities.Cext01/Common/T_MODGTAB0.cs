...
namespace BCH.Comex.Core.Entities.Cext01.Common
{
    ...
    //----------------------------------------------------------------------------
    //Arreglo de Monedas y Paises.
    //----------------------------------------------------------------------------
    public class T_MndPai
    {
        public short mnd_mndcod { get; set; }  //Código Banco Chile.
        public short mnd_mndcbc { get; set; }  //Código Banco Central.
        public short mnd_mndsbf { get; set; }  //Nombre o Descripción.
        public string mnd_mndnom { get; set; }  //Nemónico.
        public string mnd_mndswf { get; set; }  //Código Swift.
        public string mnd_mndnmc { get; set; }  //Indica Sin Decimal.
        public short mnd_mndpai { get; set; } // Codigo Moneda del pais
    ...
    public class Ty_Cor
    {
        ...
        public Ty_Cor Copy()
        {
            return (Ty_Cor)this.MemberwiseClone();
        }
    }
    //----------------------------------------------------------------------------
    //Paridades.
    ...
    public class T_MODGTAB0
    {
        ...
        public T_Mnd[] VMnd;
        public T_MndPai[] VMndPai;
        public static Dictionary<short, int> VMndDict;
        public static Dictionary<short, int> VMndPaiDict;
        //MOneda Dolar.-
        public T_Pai[] VPai;
        ...
        public Ty_Cor WCor = new Ty_Cor();     // Variable Corresponsal.
        public Ty_Cor WCorNul = new Ty_Cor();     // Variable Corresponsal Nula.
        // ----------------------------------------------------------------------------
        // Arreglo de Días Feriados.
        // ----------------------------------------------------------------------------
