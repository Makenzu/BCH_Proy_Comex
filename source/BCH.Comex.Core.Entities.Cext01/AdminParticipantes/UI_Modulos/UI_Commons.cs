...
namespace BCH.Comex.Core.Entities.Cext01.AdminParticipantes.UI_Modulos
{
    ...
    //public class UI_TextBox_ : UI_Control
    //{
    ...
    //public class UI_CheckBox_ : UI_Control
    //{
    ...
    //public class UI_OptionItem_ : UI_Control
    //{
    //    public bool Selected { get; set; }
    //    public string Value { get; set; }
    //    public string Name { get; set; }

    //    public UI_OptionItem_()
    //    {
    //        Value = string.Empty;
    //    }
    //}
    ...
    //public class UI_Button_ : UI_Control
    //{
    //    public string Text { set; get; }
    ...
    //public class UI_Combo_ : UI_List
    //{
    ...
    //        get
    //        {
    //            return ListIndex == -1 ? (int?)null : Items.ElementAt(ListIndex).Data;
    //        }
    //    }
    ...
    //public class UI_ListBox_ : UI_List
    //{
    //    private int _ListIndex;
