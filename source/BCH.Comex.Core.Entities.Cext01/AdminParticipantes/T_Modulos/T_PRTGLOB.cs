...
namespace BCH.Comex.Core.Entities.Cext01.AdminParticipantes.T_Modulos
{
    public class PrtGlob
    {
        ...
        public bool FlagIngresoCuentas = false;
    }

    public class prtyprincipal
    {
        public PrtGlob PrtGlob;
        public string idparty = string.Empty;
        public int estado = 0;
        public int tipo = 0;
        public int Flag = 0;
        ...
        public string creacosto = string.Empty;
        public string creauser = string.Empty;
        public string modcosto = string.Empty;
        public string moduser = string.Empty;
        public int multiple = 0;
        public string oficina = string.Empty;
        public string ejecutivo = string.Empty;   //los códigos
        public string actividad = string.Empty;
        public string riesgo = string.Empty;
        public int codbco = 0;
        public int prime = 0;
        public int libor = 0;
        public double spread = 0;
        public string swif = string.Empty;
        public int aladi = 0;
        public string ejecorr = string.Empty;
    ...
    public class prtyccta
    {
        ...
        /// <summary>
        /// Número de Cuenta sin formato
        /// </summary>
        public string CuentaSinFormato
        {
            get
            {
                string nroCuemta = string.Empty;
                /// Llevamos el numero de producto a un arreglo de caracteres
                char[] caracter = cuenta.ToCharArray();
                /// Recorremos cada elementos
                foreach (var elemento in caracter)
                {
                    /// Validamos si el caracteres es númerico, de ser asi, se concatena.
                    if (char.IsNumber(elemento))
                        nroCuemta += elemento;
                }
                /// Se devuelve el elemento
                return nroCuemta != null ? nroCuemta.Trim() : null;
            }
        }
    }
