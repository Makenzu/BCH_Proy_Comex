...
namespace BCH.Comex.Core.Entities.Cext01.FundTransfer.T_Modulos
{
    ...
    //****************************************************************************
    //Arreglo para las distintas Sucursales.
    //****************************************************************************
    public class T_Suc
    {
	    public string nomsuc;  //Nombre de la Sucurasal.
	    public short codsuc;  //Código de la Sucursal.
    }
    ...
    //****************************************************************************
    //Arreglo para las Cuentas Corrientes dependiendo de un Party en especial.
    //****************************************************************************
    public class T_OriCC
    {
	    public string ctacte;  //Número de Cta.Cte.
	    public string CtaCte_t;  //Número de Cta.Cte(Descripción).
	    public short MonExt;  //Indicador de moneda extranjera.
	    public short CodMnd;  //Código de la moneda.
	    public short Activa;  //Esta Activa la Cuenta?(1/0).
    }

    //****************************************************************************
    //Tabla de Origen Vía Destino.
    //****************************************************************************
    // Se agrega elemento CtaVig para determinar cuenta vigenteable
    public class T_Ovd
    {
	    public short NumCta;  //Código de Origen Via Destino.
	    public string NomCta;  //Descripción de Origen Vía Destino.
	    public string NemCta;  //Nemónico de Origen Via Destino.
	    public short monnac;  //Moneda de Origen Via Destino.
	    public short CtaOri;  //Origen de Origen Via Destino.
	    public short CtaVia;  //Vía de Origen Via Destino.
	    public short CtaVue;  //Vuelto de Origen Via Destino.
	    public short CtaVig;  //Cuenta Vigenteable
    ...
    public class T_xOri
    {
	    public short NumCta;  //Id. Cta Contable.
    ...
    public class T_MODXORI
    {
        ...
        public static Dictionary<DateTime, T_CodTran[]> Vx_CodTranCache = new Dictionary<DateTime,T_CodTran[]>();
