...
namespace BCH.Comex.Common.UI_Modulos
{
    ...
    public class UI_Grid : UI_List
    {
        ...
        //public UI_GridItem SelectedItem {
        //    get
        //    {
        //        try
        //        {
        ...
        public int get_IData(int index)
        {
            try
            {
                if (index > -1 && Items.Count > 0)
        ...
        public void set_ItemData(int ind, int ind_partida)
        {
            try
            {
                this.Items[ind].Data = ind_partida;
            }
            catch
            {
                this.Items[this.Items.Count - 1].Data = ind_partida;
            }

        }

        public int Add_Value(UI_GridItem uI_GridItem)
        {
            this.Items.Add(uI_GridItem);
            return this.Items.Count - 1;
        }

        public void Add_Value_At(int ind, UI_GridItem uI_GridItem)
        {
            try
            {
                this.Items.Insert(ind, uI_GridItem);
            }
            catch
            {
                this.Items.Add(uI_GridItem);
        ...
        public void set_ItemValue(int pos, UI_GridItem l)
        {
            this.Items[pos] = l;
        }
    }
    ...
    public class UI_ListBox : UI_List
    {
        ...
        public string SelectedItem
        {
            get
            {
                ...
                else
                {
                    try
                    {
                        return this.Items[this.ListIndex].Value;
                    }
                    catch
                    {
                        return String.Empty;
        ...
        public void set_ItemData(int index, int data)
        {
        ...
        public int Add_Value(string s)
        {
            this.Items.Add(new UI_ListBoxItem() { Data = this.Items.Count, Value = s });
            return this.Items.Count - 1;
        }

        public void Add_Value_At(int ind, string l)
        {
            this.Items.Insert(ind, new UI_ListBoxItem() { Value = l });
        }

        public void set_ItemValue(int index, string value)
        {
