...
namespace BCH.Comex.Core.BL.XGCV
{
   public static class MODGUSR1
   {
      ...
      public static int SyGetn_Usr1(string CenCos)
      {
         int SyGetn_Usr1 = 0;
         ...
         try
         {
            ...
            Que = "Exec " + MODGSRM.ParamSrm8k.base_migname + "." + MODGSRM.ParamSrm8k.usuario + "." + "sce_usr_s03 ";
            Que = Que.LCase();
            ...
            for(I = 1; I <= n; I += 1)
            {
               ...
               // --------------------------------------------
               if (VUsr[I].FecIni != "" && VUsr[I].FecFin != "")
               {
      ...
      public static int SyUpd_Usr(string CenCos,string CodUsr,string CodFec)
      {
         int SyUpd_Usr = 0;
         ...
         try
         {
            ...
            Que = "Exec " + MODGSRM.ParamSrm8k.base_migname + "." + MODGSRM.ParamSrm8k.usuario + "." + "sce_usr_u02 ";
            Que = Que.LCase();
            Que = Que + MODGSYB.dbcharSy(CenCos) + " , ";
